...
export const METHOD_GUARDS_METADATA = Symbol('banhmi:method_guards')
export const METHOD_INTERCEPTORS_METADATA = Symbol('banhmi:method_interceptors')
export const METHOD_FILTERS_METADATA = Symbol('banhmi:method_filters')
