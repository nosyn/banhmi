/**
 * Parameter decorator that documents the message context injection position.
 *
 * @remarks
 ...
 * findOne(\@Payload() id: string, \@Ctx() ctx: MicroserviceMessage) {
...
export type { MicroserviceMessage } from '../types'
